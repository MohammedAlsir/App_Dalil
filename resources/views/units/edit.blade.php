...
<div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
        <div class="x_title">
            <h2> تعديل بيانات الوحدة السكنية
                <small>بيانات الوحدة السكنية الاساسية</small>
            </h2>
        ...
        <div class="x_content">
            <br>
            <form  method="POST" action="{{route('units.update',$unit->id)}}" id="demo-form2" data-parsley-validate="" enctype="multipart/form-data" class="form-horizontal form-label-left" >
                @csrf
                @method('put')
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" value="{!!$unit->{'name_'.$localeCode}!!}" required id="name_{{$localeCode}}" name="name_{{$localeCode}}"
                            class="form-control col-md-7 col-xs-12">
                    </div>
                </div>
                @endforeach

               @livewire('edit-select-state',['id'=>$unit->id])
                ...
                {{-- <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <select id="stars" name="stars" required  class="form-control col-md-7 col-xs-12">
                            ...
                            <option  {{$units->stars == 1 ? "selected":""}} value="1">1</option>
                            <option  {{$units->stars == 2 ? "selected":""}} value="2">2</option>
                            <option  {{$units->stars == 3 ? "selected":""}} value="3">3</option>
                            <option  {{$units->stars == 4 ? "selected":""}} value="4">4</option>
                            <option  {{$units->stars == 5 ? "selected":""}} value="5">5</option>
                        </select>
                    </div>
                </div> --}}
                ...
                @foreach(LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" required id="location_{{$localeCode}}" value="{!!$unit->{'location_'.$localeCode}!!}" name="location_{{$localeCode}}"
                                class="form-control col-md-7 col-xs-12">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <textarea id="mytextarea" required rows="5" name="features_{{$localeCode}}"
                                class="form-control col-md-7 col-xs-12">{!!$unit->{'features_'.$localeCode}!!}</textarea>
                        </div>
                    </div>
                @endforeach
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12" style="padding:0">
                        ...
                        {{-- @livewire('delete-image', ['id' => $units->id]) --}}
                        {{-- @livewire('delete-image', ['units_id' => $unit->id ,'unit_id'=>0]) --}}
                        @livewire('delete-image', ['hotel_id' => $unit->id ,'appartment_id'=>0])
